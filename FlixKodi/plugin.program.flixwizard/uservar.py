...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Flix[/B][/COLOR]Wizard'
BUILDERNAME = 'FlixWizard'
EXCLUDES = [ADDON_ID, 'repository.flixkodi']
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Flix[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing FlixWizard.\n\nContact us on Github at http://www.github.com/FlixKodi/plugin.program.flixwizard/'
...
REPOID = 'repository.flixkodi'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/FlixStudioss/FlixKodi/main/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/FlixStudioss/FlixKodi/main/zips/repository.flixkodi/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Flix[/B][/COLOR]Wizard'
